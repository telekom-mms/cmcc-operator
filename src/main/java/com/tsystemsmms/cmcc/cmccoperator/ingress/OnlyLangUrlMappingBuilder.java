...
public class OnlyLangUrlMappingBuilder extends AbstractUrlMappingBuilder {
  ...
  public String buildLiveUrl(SiteMapping siteMapping, String segment) {
    String site = siteMapping.getHostname();
    String fqdn = concatOptional(isEmpty(getDefaults().getNamePrefixForIngressDomain()) ? getDefaults().getNamePrefix() : getDefaults().getNamePrefixForIngressDomain(),
            site,
            isEmpty(getDefaults().getNameSuffixForIngressDomain()) ? getDefaults().getNameSuffix() : getDefaults().getNameSuffixForIngressDomain());
    fqdn += getDefaults().getIngressDomain();
